<template>
   <aside id="default-sidebar" class="fixed top-69 left-0 z-40 w-[25rem] h-screen shadow-lg border-solid transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      <div class="h-full px-3 py-4 overflow-y-auto bg-slate-100">
         ...
         <div class="mb-4">
            <label class=""></label>
            <label for="countries" class="mb-5 text-md font-medium text-gray-900 text-slate-800">Location Type</label>
            <select id="countries" class="block w-full p-3 text-sm text-slate-500 border border-gray-300 rounded-lg bg-gray-50">
         ...
         <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
         <li>
            <a href="#" class="flex items-center p-2 text-slate-100 transition duration-75 bg-green-600 rounded-lg hover:bg-green-800 group">
               <svg class="flex-shrink-0 w-5 h-5transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 17 20">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-slate-100 transition duration-75 bg-green-600 rounded-lg hover:bg-green-800 group">
               <svg class="flex-shrink-0 w-5 h-5transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-slate-100 transition duration-75 bg-green-600 rounded-lg hover:bg-green-800 group">
               <svg class="flex-shrink-0 w-5 h-5transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 21">
