                ...
                <form class="p-4 md:p-5 flex-grow overflow-y-auto" @submit.prevent="handleSubmit">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input v-model="formData.name" type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Marina name">
                        </div>
                        <div class="col-span-2">
                            <label for="canal" class="block mb-2 text-sm font-medium text-gray-900">Canal Name</label>
                            <input v-model="formData.canalName" type="text" name="canal" id="canal" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="The name of the canal the marina is on">
                        </div>
                        <div class="col-span-2">
                            <label for="address" class="block mb-2 text-sm font-medium text-gray-900">Address</label>
                            <input v-model="formData.address" type="text" name="address" id="address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="The address of the marina">
                        </div>
                        <div class="col-span-2">
                            <label for="website" class="block mb-2 text-sm font-medium text-gray-900">Website</label>
                            <input v-model="formData.website" type="text" name="website" id="website" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="The website of the marina">
                        </div>
                        <div class="col-span-2">
                            <label for="phone" class="block mb-2 text-sm font-medium text-gray-900">Phone Number</label>
                            <input v-model="formData.phoneNumber" type="text" name="phone" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="The phone number of the marina">
                        </div>
      ...
      const props = defineProps({
        ...
        const handleSubmit = async () => {
            ...
            try{
                ...
                const params : client.SuggestionMarinaSuggestionsAddPostRequest = {
                    newMarinaSuggestionModel:{
                        userEmail: formData.value.email ?? 'null',
                        marinaName: formData.value.name ?? 'null',
                        coordinates: 'null',
                        websiteLink: formData.value.website ?? 'null',
                        address: formData.value.address ?? 'null',
                        canalName: formData.value.canalName ?? 'null',
                ...
                const res = await SuggestionApi.suggestionMarinaSuggestionsAddPost(params);
